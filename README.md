...
`edge_rv_public.fl` lists unchanged open RTL from `src/edge-rv`. Use `edge_e3enc_mixed.fl` for the complete design, or combine the private RTL with target-specific SRAM models/replacements for FPGA/OpenROAD.
